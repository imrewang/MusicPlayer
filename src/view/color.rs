...
lazy_static! {//Rust 库使用 - lazy_static https://zhuanlan.zhihu.com/p/145893481
    static ref COLOR_HEX_REGEX: Regex =//命名规范 https://course.rs/practice/naming.html
...
fn parse_hex_color(color: &str) -> Color {
    ...
    Color::Rgb(
        u8::from_str_radix(capture.get(1).unwrap().as_str(), 16) //Converts a string slice in a given base to an integer.
            .ok()
            .unwrap(),
